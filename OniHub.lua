...
game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "OniHub",
        Text = "Enjoy the script | Load in 5 secs",
        Duration = 6
})
...
TabCredits = Window:CreateTab('Credits', true, 'rbxassetid://3926305904', Vector2.new(524, 44), Vector2.new(36, 36))
...
Paragraph = Section:CreateParagraph('Recover Script', 'Bacon[SynxAzxure#1440]')
